...
The Workout Creator is a Python program designed to assist users in creating personalized, full-body workout routines directly in their terminal. With warm-up, main workout, and cool-down segments, it aims to provide an effective and balanced exercise experience based on user preferences.
...
**Input Validation**:
- Ensures users enter valid numbers and choices throughout the program.
...
|  Menu Selection Validation  |               Selecting incorrect menu options               |              Programm should prompt the user to enter a valid option              |     Pass      |
